...
describe('POST /api/test-runs/dispatch', () => {
    ...
    it('falls back to source-backed runtime config when cwd runtime config is missing', async () => {
        mocks.testCaseFindUnique.mockResolvedValue({
            id: 'tc-1',
            source: '/home/newman/magic/skytest-agent/.case-studies/case-study-app/.skytest/tests/student/HAN-C02.case.yaml',
            project: {
                id: 'project-1',
                teamId: 'team-1',
                team: {
        ...
        expect(response.status).toBe(200);
        expect(mocks.loadRuntimeConfigForCwd).toHaveBeenNthCalledWith(2, '/home/newman/magic/skytest-agent/.case-studies/case-study-app');
    });
