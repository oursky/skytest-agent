...
import ConfigurationVariablesPanel from './configurations-section/ConfigurationVariablesPanel';
...
import type { EditState, FileUploadDraft } from './configurations-section/config-types';
import {
    buildAuthHeaders,
