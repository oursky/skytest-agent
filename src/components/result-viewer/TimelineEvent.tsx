            ...
            {event.type === 'screenshot' && event.data && 'src' in event.data && (
                <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        {event.browserId?.startsWith('android_') && (
                            <span className="text-xs bg-green-100 text-green-700 px-1.5 py-0.5 rounded">📱 Android</span>
                        )}
                    </div>
                    <div
                        className={`relative rounded-md overflow-hidden border border-gray-200 shadow-sm bg-white cursor-pointer group ${event.browserId?.startsWith('android_') ? 'max-w-[280px]' : ''}`}
                    ...
                    >
                        <Image
                            ...
                            width={event.browserId?.startsWith('android_') ? 1080 : 1280}
                            height={event.browserId?.startsWith('android_') ? 2400 : 800}
